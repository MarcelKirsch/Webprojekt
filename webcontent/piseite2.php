	...
	<div class="container">
		...
		<div class="row container-body">
			...
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-md-7" style="text-align: center">
						...
						<div class="item">
							<img class="slide-image" src="../piimg/raspi2/Thumbnail.jpg" alt="">
						</div>
							</div>
			...
			<div class="col-md-12">
				...
				<div class="artikel-beschreibung">Der Raspberry Pi 2 steigt in ein neues, höheres Level auf. Eine Kombinantion aus ca. sechsfacher Rechenkraft, 
				verdoppelten Arbeitsspeicher und die abwärts- Kompatiblität zum Modell B+ garantieren noch leistungsstärkere und aufwendigere Projekte. 
				Der Raspberry Pi 2 ist durch die neuen Eigenschaften das perfeke Board für professionelle und Hobbyanwender.</div>
			</div>
		</div>
